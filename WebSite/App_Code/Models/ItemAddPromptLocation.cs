...
{
    public enum ItemAddPromptLocationDataField
    {
    ...
    public partial class ItemAddPromptLocationModel : BusinessRulesObjectModel
    {
        ...
        public ItemAddPromptLocationModel()
        {
        }

        public ItemAddPromptLocationModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[ItemAddPromptLocationDataField field]
        {
            get
            {

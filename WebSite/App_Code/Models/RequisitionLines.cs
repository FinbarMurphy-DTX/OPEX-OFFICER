...
{
    public enum RequisitionLinesDataField
    {
    ...
    public partial class RequisitionLinesModel : BusinessRulesObjectModel
    {
        ...
        public RequisitionLinesModel()
        {
        }

        public RequisitionLinesModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[RequisitionLinesDataField field]
        {
            get
            {

...
{
    public enum RequisitionTextLocationDataField
    {
    ...
    public partial class RequisitionTextLocationModel : BusinessRulesObjectModel
    {
        ...
        public RequisitionTextLocationModel()
        {
        }

        public RequisitionTextLocationModel(BusinessRules r) :
                base(r)
        {
        }
        ...
        public FieldValue this[RequisitionTextLocationDataField field]
        {
            get
            {

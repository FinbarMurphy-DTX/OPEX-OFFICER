...
namespace DatatecnixOfficerII.Rules
{
	public partial class SerialNumbersLocationBusinessRules : DatatecnixOfficerII.Rules.SharedBusinessRules
    {
        ...
        /// </summary>
        [Rule("r100")]
        public void r100Implementation(SerialNumbersLocationModel instance)
        {
            ...
            OpexMessage("SN", "20", instance.SerialNumber.ToString(),
                SelectFieldValue("Parameters_NewSerialNumber").ToString(), instance.StaffuEplNumber +"-" + instance.StaffuSurname);

...
namespace DatatecnixOfficerII.Handlers
{
    ...
    public class SiteBase : DatatecnixOfficerII.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2024 DatatecnixOfficerII. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            var themePath = Server.MapPath("~/App_Themes/DatatecnixOfficerII");
            if (Directory.Exists(themePath))
                foreach (var stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!fileName.Equals("_Theme_Aquarium.css"))
                    {
                        ...
                        {
                            Href = ("~/App_Themes/DatatecnixOfficerII/" + fileName)
                        };

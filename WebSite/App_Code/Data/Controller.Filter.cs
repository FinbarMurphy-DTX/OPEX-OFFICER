                ...
                foreach (var filterExpression in page.Filter)
                {
                    ...
                    if (filterMatch.Success)
                    {
                        ...
                        while (valueMatch.Success)
                        {
                            ...
                            {
                                var filterFieldName = expressions[field.ExpressionName()];
                                if (filterFieldName.ToLower() == "null")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                if (Regex.IsMatch(filterFieldName, "^\\w+$"))
                                                    sb.AppendFormat("{1}{0}{2}", filterFieldName, _leftQuote, _rightQuote);
                                                else
